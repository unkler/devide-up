...
<html>
  <head>
    ...
    />
    <title>Devide Up | 現場作業向け スケジュール管理ツール</title>
  </head>
  <body class="text-gray-800 antialiased">
        ...
        >
          ...
          <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
            ...
            {{-- <li class="flex items-center">
              ...
              >
                <i class="fas fa-arrow-alt-circle-down"></i> ログイン
              </button>
            </li>
            <li class="flex items-center">
              <button
                ...
                style="transition: all 0.15s ease 0s;"
              >
                <i class="fas fa-arrow-alt-circle-down"></i> サインアップ
              </button>
            </li> --}}
            <li class="flex items-center">
              <a
                ...
                ><i
                  class="lg:text-gray-300 text-gray-500 fas fa-sign-in-alt text-lg leading-lg "
                ></i
                ><span class="inline-block ml-2">ログイン</span></a
              >
            </li>
            <li class="flex items-center">
              <a
                ...
                ><i
                  class="lg:text-gray-300 text-gray-500 fas fa-user-plus text-lg leading-lg "
                ></i
                ><span class="inline-block ml-2">サインアップ</span></a
              >
            </li>
          </ul>
        </div>
    ...
    <main>
      ...
      >
      <div class="absolute top-0 w-full h-full bg-center bg-cover" style="background-image: url('https://devide-up.s3.ap-northeast-1.amazonaws.com/images/hero.jpg');">
          <span
            id="blackOverlay"
